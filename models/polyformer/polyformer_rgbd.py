...
@register_model("polyformer_rgbd")
class PolyFormerRGBDModel(TransformerModel):
    ...
    @staticmethod
    def add_args(parser):
        super(PolyFormerRGBDModel, PolyFormerRGBDModel).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
        ...
        parser.add_argument("--use-depth", default=True, help="Use depth image")
...
@register_model_architecture("polyformer_rgbd", "polyformer_rgbd_l")
def polyformer_rgbd_l_architecture(args):
...
@register_model_architecture("polyformer_rgbd", "polyformer_rgbd_b")
def polyformer_rgbd_b_architecture(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 768)
    args.out_index = getattr(args, "out_index", 3)
    ...
    polyformer_rgbd_l_architecture(args)
